...
namespace Helper
{
    public class MenuItemNamesCreator
    {
        // 無効な文字を管理する配列
        ...
        private const string PATH = "Assets/99_Extensions/01_Helper/Names.cs";        // ファイルパス
        ...
        public static void CreateScript()
        {
            ...
            // 名前空間
            builder.AppendLine("// This code is auto-generated by MenuItemNamesCreator.");
            builder.AppendLine($"namespace {typeof(MenuItemNamesCreator).Namespace}");
            builder.AppendLine("{");
            ...
            builder.AppendLine("/// </summary>");
            builder.AppendFormat("public enum SceneName").AppendLine();
            builder.AppendLine("{");
            ...
            builder.AppendLine("/// </summary>");
            builder.AppendFormat("public static class TagName").AppendLine();
            builder.AppendLine("{");
            ...
            builder.AppendLine("/// </summary>");
            builder.AppendFormat("public static class LayerName").AppendLine();
            builder.AppendLine("{");
